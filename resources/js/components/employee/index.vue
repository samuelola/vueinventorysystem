<template>
    ...
    <div class="row">
      ...
      <router-link to="/store-employee" class="btn btn-primary" style="margin-left: 15px;">Add Employees</router-link>
 ...
 export default{
  ...
  computed:{
    ...
    filterSearch(){
      ...
      return this.employees.filter(theemployee => {

          return theemployee.name.match(this.searchTerm)
      })
    }
       ...
       deleteEmployee(id){
          ...
          if (result.isConfirmed) {
              ...
              .then(()=>{
                 ...
                 this.employees = this.employees.filter(theemployee => {

                 return theemployee.id != id
      })
