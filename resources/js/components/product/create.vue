<template>
    ...
    <div class="row">
      ...
      <router-link to="/product" class="btn btn-primary" style="margin-left: 15px;">All Products</router-link>
                      ...
                      <div class="form-row">
                        <div class="col-md-6">
                         ...
                         <div class="col-md-6">
                             ...
                             <small class="text-danger" v-if="errors.nid">{{errors.product_quantity[0]}}</small>
                        </div>
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-row">
                        <div class="col-md-6">
                         ...
                         <div class="col-md-6">
                             <img v-if="form.image " :src="form.image" alt="image" style="height:40px;width:40px">
                            <img v-else=" "  src="/backend/mydefault.png" alt="image" style="height:40px;width:50px">
