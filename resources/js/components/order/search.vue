<template>
  <div>
    ...
    <div class="row">
      ...
      <router-link to="/order" class="btn btn-primary" style="margin-left: 15px;">Today Order</router-link>
                      ...
                      <div class="form-row">
                        <div class="col-md-12">
                          <label for=""><b>Search by Date</b></label>
                             <input type="date" required="" class="form-control" id="exampleInputFirstName"  v-model="date">
